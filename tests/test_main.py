...
from src.main import (
    ...
    get_financial_transactions_operations,
    filter_transactions,
    sort_transactions,
    filter_by_currency,
    print_transactions,
...
class TestFinancialFunctions(unittest.TestCase):
    ...
    def test_sort_transactions(self):
        transactions = [
            {'date': '2023-10-01T21:27:25.241689'},
            {'date': '2022-10-01T21:27:25.241689'}
        ]
    ...
    def test_print_transactions(self, mock_print):
        transactions = [{'date': '2023-10-01T21:27:25.241689', 'description': 'Payment for service', 'amount': '1000',
                         'currency_code': 'RUB'}]
